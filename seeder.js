...
async function seedData() {
  for (let i = 0; i < 10; i++) {
    ...
    let productItem = new Product({
      winner_id: [
        new mongoose.Types.ObjectId('658d8d59ded725a37cb8924e'),
        new mongoose.Types.ObjectId('658ed6c300a80ce6b80ed846'),
        new mongoose.Types.ObjectId('65900f011ac7272c10308877')
      ].at(faker.number.int() % 3),
      seller_id: [
        new mongoose.Types.ObjectId('658d8d59ded725a37cb8924e'),
        new mongoose.Types.ObjectId('658ed6c300a80ce6b80ed846'),
        new mongoose.Types.ObjectId('65900f011ac7272c10308877')
